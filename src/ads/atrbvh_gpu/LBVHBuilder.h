...
public:
    ...
    virtual BVHTree* BuildTree(const SceneWrapper* sceneWrapper, float ci, float ct, float* sah, float* time_ms) override;
...
private:
    ...
    template <typename T> BVHTree* BuildTreeNoTriangleSplitting(const SceneWrapper* sceneWrapper, float ci, float ct, float* sah, float * time_ms)  const;
